...
CATALINA_OPTS="-Xmx6144m -Xms512m -XX:+UseG1GC -Dfile.encoding=UTF8 -Dorg.apache.tomcat.util.buf.UDecoder.ALLOW_ENCODED_SLASH=true -Dorg.apache.catalina.connector.CoyoteAdapter.ALLOW_BACKSLASH=true -d64"
...
export HOSTNAME=uc3-ingest02x2-prd
export WORKERNAME=ingest02
